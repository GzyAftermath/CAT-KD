...
class VGG_test(nn.Module):
    def __init__(self, cfg, batch_norm=False, num_classes=1000):
        ...
        self.conv_test = nn.Conv2d(512, num_classes, kernel_size=1, padding=0, bias=False)
...
def vgg8_bn(**kwargs):
    ...
    return model
def vgg8_bn_test(**kwargs):
    """VGG 8-layer model (configuration "S")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG_test(cfg["S"], batch_norm=True, **kwargs)
    return model
def vgg8_bn_self_AT(**kwargs):
    """VGG 8-layer model (configuration "S")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def vgg13(**kwargs):
    ...
    return model
def vgg13_test(**kwargs):
    """VGG 13-layer model (configuration "B")
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = VGG_test(cfg["B"], **kwargs)
    return model
...
def vgg13_bn(**kwargs):
    ...
    return model
def vgg13_bn_test(**kwargs):
    """VGG 13-layer model (configuration "B") with batch normalization"""
    model = VGG_test(cfg["B"], batch_norm=True, **kwargs)
    return model
